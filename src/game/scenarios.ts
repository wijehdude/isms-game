...
export const SCENARIOS: ScenarioDefinition[] = [
  {
    ...
    objectiveText: "Reach rating 60, coverage 42% and both workforce happiness scores of 58 by Day 30.",
    objectives: [
      { metric: "rating", target: 60, label: "Camp rating" },
  ...
  },
  {
    ...
    objectiveText: "Reach rating 68 and catch 6 infiltrators with at least $250k remaining by Day 45.",
    objectives: [
      { metric: "rating", target: 68, label: "Camp rating" },
  ...
  },
  {
    ...
    objectiveText: "Reach rating 72, operator happiness 68 and catch 10 infiltrators by Day 60.",
    objectives: [
      { metric: "rating", target: 72, label: "Camp rating" },
  ...
  },
  {
    ...
    objectiveText: "Play endlessly. Monthly command funding scales with security capability and workforce confidence.",
    objectives: [],
    startCash: 1_800_000,
    deadlineDays: null,
