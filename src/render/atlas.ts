...
export class RuntimeSpriteAtlas {
  ...
  private drawSprite(name: SpriteName): void {
    ...
    if (name === "camera") {
      pixel(22, 17, 4, 25, "#3b4650"); pixel(18, 40, 12, 4, "#222c31");
      pixel(16, 12, 20, 10, "#eef3e5"); pixel(32, 14, 7, 6, "#172226"); pixel(12, 15, 5, 4, "#f2b84b");
    } else if (name === "lidar") {
      pixel(20, 13, 10, 13, "#e8d7a9"); pixel(18, 16, 14, 6, "#527263"); pixel(22, 26, 5, 7, "#34483f");
      pixel(14, 32, 4, 12, "#38433d"); pixel(30, 32, 4, 12, "#38433d"); pixel(22, 31, 4, 13, "#38433d"); pixel(31, 17, 5, 3, "#70d6c4");
